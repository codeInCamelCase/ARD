...
public class AboutMACActivityTest {
    ...
    public void testTextView() throws Exception {
        TextView textView = (TextView) activityTestRule.getActivity().findViewById(R.id.about_mac_desc);
    ...
    public void testSharedPreferences() throws Exception {
        ...
        SharedPreferences sharedPreferences = contextWrapper.getSharedPreferences(AHC.USER_PREFERENCES, Context.MODE_PRIVATE);
        String text = sharedPreferences.getString(AHC.TEXT_ABOUT_MAC, "");
        assertNotNull(text);
    }
}
