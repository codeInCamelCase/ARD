...
import in.ac.bits_pilani.goa.ard.fragments.ForumFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(@NonNull final MenuItem item) {
        ...
        } else if (id == R.id.bottom_nav_forum) {
    ...
    @Override
    public void onFragmentInteraction(final int type) {
