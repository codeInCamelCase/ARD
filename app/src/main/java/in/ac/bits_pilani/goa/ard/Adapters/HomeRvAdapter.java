...
public class HomeRvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder.getItemViewType() == AHC.IMAGE_CARD_TYPE) {
    ...
    /**
     * default card viewHolder.
     */
    public class ViewHolderDefault extends RecyclerView.ViewHolder {

        /**
         * title in default card.
         */
        public TextView viewHolderDefaultTitle;

        /**
         * create viewholder for default card.
         * @param view view to attach
         */
        public ViewHolderDefault(final View view) {
            super(view);
            this.viewHolderDefaultTitle = (TextView) view.findViewById( R.id.home_default_title );
        }
    }
